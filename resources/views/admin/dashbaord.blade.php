        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="p-3 bg-success bg-opacity-10 rounded">
                            <iconify-icon icon="solar:user-id-bold-duotone" class="fs-1 text-success"></iconify-icon>
                        </div>
                        <div class="ms-3">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="p-3 bg-warning bg-opacity-10 rounded">
                            <iconify-icon icon="solar:book-bookmark-bold-duotone" class="fs-1 text-warning"></iconify-icon>
                        </div>
                        <div class="ms-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="p-3 bg-danger bg-opacity-10 rounded">
                            <iconify-icon icon="solar:users-group-rounded-bold-duotone" class="fs-1 text-danger"></iconify-icon>
                        </div>
                        <div class="ms-3">
                            <h6 class="text-muted mb-1 fw-normal">Total Users</h6>
                            <h3 class="mb-0 fw-bold">{{ $stats['total_users'] }}</h3>
