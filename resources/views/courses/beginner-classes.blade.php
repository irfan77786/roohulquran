...
<section id="hero" class="hero section dark-background">
    <img src="{{ cloudinary_image('assets/img/hero-bg-3.webp') }}" alt="noorani qaida course" class="desktop-image" data-aos="fade-in">
    <img src="{{ cloudinary_image('assets/img/hero-bg-1.webp') }}" alt="online noorani qaida course" class="mobile-image" data-aos="fade-in">
