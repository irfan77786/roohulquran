...
<section id="hero" class="hero section dark-background">
  <img src="{{ cloudinary_image('assets/img/hero-bg-3.webp') }}" alt="quran memorization online" class="desktop-image" data-aos="fade-in">


  <img src="{{ cloudinary_image('assets/img/hero-bg-1.webp') }}" alt="online memorize quran" class="mobile-image" data-aos="fade-in">
