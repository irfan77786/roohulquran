            ...
            <div class="row gy-4 align-items-center">
                ...
                <div class="col-lg-6 order-2 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                    <div class="card p-4 shadow"
                        ...
                        <h2><b>About</b> Us ?</h2>
                        <p>
                            Millions of Muslims worldwide face challenges accessing quality Islamic education due to time
                            constraints,
                        ...
                        <div class="nested-card p-3 mb-3 nt-5" style="background-color: #f3d8d8; border-radius: 8px;">
                            ...
                            <p>
                                Our mission is to democratize Islamic education by providing world-class instruction with
                                top-notch
                                Islamic instructors, especially those with native Arabic backgrounds, and eliminating
                                geographical
                                barriers.
                            </p>
                        </div>
                        ...
                        <div class="nested-card p-3" style="background-color: #cad4dd; border-radius: 8px;">
                            ...
                            <p>
                                Our Vision
                                Our vision is to empower global Muslim communities through transformative, readily
                                accessible,
                                budget-friendly, high-quality Islamic education, providing them with an advanced
                                technology-based
                                learning platform.
                            </p>
                        </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-12 text-center mb-4">
                    ...
                    <p class="col-lg-6 mx-auto mt-5" style="text-align:inherit;line-height: 1.8;">
                        There are many reasons to choose Roohul Quran for your Online Quran learning journey. Our Online
                        Quran
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-12 text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p style="color: #000000; font-size: 1.1rem; line-height: 1.8; text-align: center;"
                        ...
                        Learn the Quran easily from home with expert teachers. Our online classes fit your daily schedule,
                        and our
                        certified teachers help you learn at your own speed. We work with students at every level, giving
                        you the
                        time and attention you need to learn well.
                        <br><br>
                        At Q Teaching, we focus on what works best for you – whether you’re just starting or want to learn
                        more.
        ...
        <div class="container">
                ...
                <div class="course-wrapper " data-aos="fade-up">
                    <div class="course-card " data-aos="fade-up">
                        <div class="course-image">
                            ...
                            <img src="{{ asset('assets/img/ai/course-1.webp') }}"
                                srcset="{{ asset('assets/img/ai/course-1.webp') }} 480w,
          ...
          {{ asset('assets/img/ai/course-1.webp') }} 1024w"
                    ...
                    <div class="course-card" data-aos="fade-up">
                        <div class="course-image">
                            ...
                            <img src="{{ asset('assets/img/ai/course-2.webp') }}"
                                srcset="{{ asset('assets/img/ai/course-2.webp') }} 480w,
          ...
          {{ asset('assets/img/ai/course-2.webp') }} 1024w"
                    ...
                    <div class="course-card" data-aos="fade-up">
                        <div class="course-image">
                            ...
                            <img src="{{ asset('assets/img/ai/course-3.webp') }}"
                                srcset="{{ asset('assets/img/ai/course-3.webp') }} 480w,
          ...
          {{ asset('assets/img/ai/course-3.webp') }} 1024w"
                    ...
                    <div class="course-card" data-aos="fade-up">
                        <div class="course-image">
                            <span class="badge-level">Advance</span>
                            <img src="{{ asset('assets/img/ai/course-4.webp') }}"
                                srcset="{{ asset('assets/img/ai/course-4.webp') }} 480w,
            ...
            <div class="bg-white shadow d-flex flex-column flex-lg-row position-relative">
                ...
                <div class="text-white p-4 rounded w-100 mt-4 mt-lg-0"
                    ...
                    <form id="trial-forms" class="form-container mx-auto">
                        @csrf
                        <div class="mb-3">
                            <input type="text" class="form-control rounded-pill w-100" name="name"
                        ...
                        <div class="mb-3">
                            <textarea class="form-control rounded-pill w-100" name="message" placeholder="Any message (optional)"></textarea>
                        </div>
