...
<section id="contact" class="contact-section position-relative" style="background: url('assets/img/ai/contact-us.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 50px 0;">
      ...
      <div class="col-lg-6 col-md-12 text-white" data-aos="fade-up">
        ...
        <ul class="list-unstyled">
          <li class="mb-4 d-flex align-items-start">
            <img src="assets/img/icons/pointing-up.png" alt="Registration" class="me-3" style="width: 40px; height: 40px;">
            <div>
              <h5 style="color: #1bd634; font-weight: bold;">Simple and Convenient Registration</h5>
              <p>Sign up easily for free Quran classes with experienced teachers. Just provide your name and contact to start learning!</p>
            </div>
          </li>
          <li class="mb-4 d-flex align-items-start">
            ...
            <div>
              ...
              <p>After you register, we will reach out to you to arrange a convenient time for your free Quran trial classes.</p>
            </div>
          </li>
          <li class="mb-4 d-flex align-items-start">
            ...
            <div>
              ...
              <p>We’ll quickly connect you with one of our expert Quran teachers, allowing you to schedule your first class at a time that works best for you.</p>
            </div>
          </li>
          <li class="d-flex align-items-start">
            ...
            <div>
              ...
              <p>Get your certificate after successfully completing the course. Start your learning journey with us today!</p>
            </div>
          </li>
        </ul>
      </div>
