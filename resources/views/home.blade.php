...
@media (max-width: 768px) {
  ...
  .text-content {
    flex: 0 0 100%; /* Make the text content take full width */
    max-width: 100%;
  }
}
/* 
@media (max-width: 768px) {
    ...
    <!-- Hero Section -->
{{-- filepath: d:\xampp\htdocs\roohulquran\resources\views\home.blade.php --}}
          ...
          {{-- <div class="col-lg-4 col-md-5 col-sm-12" data-aos="fade-up" data-aos-delay="200">
              <div class="form-container p-4 bg-light rounded shadow">
                  ...
                  <form action="/" method="POST">
                      ...
                      <button type="submit" class="w-100 p-2 rounded-2" style="background-color: #44137c;color:white">Get Free Trial Class</button>
                  </form>
              </div>
          </div> --}}
      </div>
