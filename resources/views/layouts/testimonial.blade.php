  ...
  <div class="container">
    <div class="row align-items-center">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-card p-4 rounded shadow bg-white">
                ...
                <div class="d-flex align-items-center">
                  <img src="{{ asset('assets/img/ai/test-1.webp') }}" alt="User" class="rounded-circle me-3"
            ...
            <div class="swiper-slide">
              <div class="testimonial-card p-4 rounded shadow bg-white">
                ...
                <div class="d-flex align-items-center">
                  <img src="{{ asset('assets/img/ai/test-2.webp') }}" alt="User" class="rounded-circle me-3"
                    style="width: 50px; height: 50px; object-fit: cover;">
                  <div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card p-4 rounded shadow bg-white">
                ...
                <div class="d-flex align-items-center">
                  <img src="{{ asset('assets/img/ai/test-3.webp') }}" alt="User" class="rounded-circle me-3"
                    style="width: 50px; height: 50px; object-fit: cover;">
                  <div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card p-4 rounded shadow bg-white">
                ...
                <div class="d-flex align-items-center">
                  <img src="{{ asset('assets/img/ai/test-4.webp') }}" alt="User" class="rounded-circle me-3"
                    style="width: 50px; height: 50px; object-fit: cover;">
                  <div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card p-4 rounded shadow bg-white">
                ...
                <div class="d-flex align-items-center">
                  <img src="{{ asset('assets/img/ai/test-5.webp') }}" alt="User" class="rounded-circle me-3"
                    style="width: 50px; height: 50px; object-fit: cover;">
                  <div>
      ...
      <div class="col-lg-6 text-center position-relative" data-aos="fade-up" data-aos-delay="200">
        <img src="{{ asset('assets/img/ai/happystudent.webp') }}" alt="Student" class="img-fluid rounded" style="max-height: 400px;">
        <div
